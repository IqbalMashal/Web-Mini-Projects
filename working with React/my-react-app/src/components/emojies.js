const emojipedia = [
  ...
  },
  {
    ...
    meaning:
      "Time to go to the doctor or take medication! The face with a medical mask is a symbol for being ill. It is also used if someone is feeling bad or even sick."
  }
];
